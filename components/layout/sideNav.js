...
const Item = ({ q, a, r }) => (
  <div className="relative overflow-hidden border-b-2 border-white">
    ...
    />
    <div className="h-12 w-full pl-5 flex items-center text-gray-600">{q}</div>
  ...
  const faqs = [
    {
      ...
      menu: [
        ...
        {
          link: "/dashboard/manage_product",
          name: "Product",
        },
        {
          link: "/dashboard/manage_category",
          name: "Category",
        },
        {
          link: "/dashboard/manage_order",
          name: "Order",
        },
        {
